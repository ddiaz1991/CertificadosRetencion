...
namespace CertificadosRetencion.Business
{
    public static class TemaColores
    {
        ...
        public static Color BotonBuscar;
        ...
        //Tema Fiory
        private static readonly Color PanelPadreF = Color.FromArgb(235, 241, 242); //186,204,222 panel donde se muestran todos las funcionalidades
        private static readonly Color PanelBotonesF = Color.FromArgb(67, 116, 163); // panel lateral
        private static readonly Color BarraTituloF = Color.FromArgb(67, 116, 163); // panel de arriba 
        private static readonly Color TextBusquedaF = Color.FromArgb(67, 116, 163);
        private static readonly Color FuenteIconosF = Color.White;
        private static readonly Color BotonGuardarF = Color.FromArgb(8, 84, 160);
        ...
        //SeleccionarColores
        #region -> Metodos
        public static void ElegirTemaColores(string Tema)
        {
            if (Tema == "Defecto")
            {
            ...
            if (Tema == "Fiory")
            {
                PanelPadre = PanelPadreF;
                PanelBotones = PanelBotonesF;
                BarraTitulo = BarraTituloF;
                TextBusqueda = TextBusquedaF;
                FuenteIconos = FuenteIconosF;
                BotonBuscar = BotonGuardarF;
